    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg--conic from-transparent via-transparent to-cyan-500 text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          style={{
            boxShadow:
              "0 0 24px 3px rgba(34, 211, 238, 0.7), 0 6px 50px 12px rgba(34, 211, 238, 0.5), 0 16px 80px 24px rgba(34, 211, 238, 0.3)",
          }}
        ></motion.div>
