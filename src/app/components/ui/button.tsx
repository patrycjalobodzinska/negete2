  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        /** CTA na całej stronie: cyan outline, spójny wygląd przycisków i linków CTA */
        cta: 'rounded-xl border border-cyan-400/50 bg-cyan-500/20 text-cyan-400 hover:bg-cyan-500/30 hover:border-cyan-400/70 transition-all duration-300',
      },
      size: {
        default: 'h-10 px-4 py-2',
        sm: 'h-9 rounded-md px-3',
        lg: 'h-11 rounded-xl px-8 py-4 text-base',
        icon: 'h-10 w-10',
      },
    },
    defaultVariants: {
